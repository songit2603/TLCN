...
const authProtectedRoutes = [
  ...
  { path: "/apps-ecommerce-add-product/:_id", component: <EcommerceAddProduct /> },
  { path: "/apps-ecommerce-orders", component: <EcommerceOrders /> },
  { path: "/apps-ecommerce-order-details", component: <EcommerceOrderDetail /> },
  { path: "/apps-ecommerce-order-details/:_id", component: <EcommerceOrderDetail /> },
  ...
  { path: "/apps-invoices-details/:_id", component: <InvoiceDetails /> },
