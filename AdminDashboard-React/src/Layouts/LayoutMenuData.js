        ...
        },
        {
            ...
            subItems: [
                ...
                },*/
                {
                    ...
                    childItems: [
                        { id: 1, label: "Quản lý sản phẩm", link: "/apps-ecommerce-products", parentId: "apps" },
                        //{ id: 2, label: "Chi tiết sản phẩm", link: "/apps-ecommerce-product-details", parentId: "apps" },
                        // { id: 3, label: "Thêm sản phẩm", link: "/apps-ecommerce-add-product", parentId: "apps" },
                        { id: 4, label: "Quản lý đơn hàng", link: "/apps-ecommerce-orders", parentId: "apps" },
                        // { id: 5, label: "Chi tiết đơn hàng", link: "/apps-ecommerce-order-details", parentId: "apps" },
                        { id: 6, label: "Quản lý tài khoản", link: "/apps-ecommerce-customers", parentId: "apps" },
                        // { id: 7, label: "Giỏ hàng", link: "/apps-ecommerce-cart", parentId: "apps" },
                        // { id: 8, label: "Đặt hàng", link: "/apps-ecommerce-checkout", parentId: "apps" },
