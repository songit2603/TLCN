        ...
        <div className="bg-primary-subtle position-relative">
          <CardBody className="p-5">
            <div className="text-center">
              <h3>Bảng điều lệ</h3>
              <p className="mb-0 text-muted">Sửa đổi lần cuối : 20/12/2023</p>
            </div>
          </CardBody>
          <div className="shape">
            <svg
        ...
        <CardBody className="p-4">
          <div className="d-flex">
            ...
            <div className="flex-grow-1">
              ...
              <p className="text-muted">        
               Quản lý sản phẩm. Thêm, xóa, sửa, xem chi tiết sản phẩm.
              </p>
              <p className="text-muted">
                Quản lý đơn hàng. Thêm, xóa, sửa, xem chi tiết đơn hàng, xuất hóa đơn.
              </p>
              <p className="text-muted">
                Quản lý tài khoản. Xóa, sửa tài khoản, phân quyền.
              </p>
            </div>
          </div>
          ...
          <div className="d-flex">
            ...
            <div className="flex-grow-1">
              ...
              <p className="text-muted">
                Quyền quản lý đơn hàng: sửa trạng thái đơn hàng
              </p>
            </div>
          </div>
        </CardBody>
