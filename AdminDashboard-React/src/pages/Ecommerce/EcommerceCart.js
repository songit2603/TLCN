            ...
            <Col xl={8}>
              <Row className="align-items-center gy-3 mb-3">
                <div className="col-sm">
                  <div>
                    <h5 className="fs-14 mb-0">Giỏ hàng của bạn ({productList.length} items)</h5>
                  </div>
                </div>
              ...
              <div className="sticky-side-div">
                <Card>
                  <CardHeader className="border-bottom-dashed">
                    <h5 className="card-title mb-0">Giá trị đơn hàng</h5>
                  </CardHeader>
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    <div className="ms-2">
                      ...
                      <p className="text-black mb-1">
                        Gói quà cùng với lời nhắn đầy yêu thương, <br />
                        Chỉ <span className="fw-semibold">$9.99</span> USD
                      </p>
                      <button
                        type="button"
