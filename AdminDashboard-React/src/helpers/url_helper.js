...
export const ADD_NEW_CUSTOMERS = "/apps/account";
export const UPDATE_CUSTOMERS = "/apps/account";
export const DELETE_CUSTOMERS = "/apps/account";
...
// Dashboard Ecommerce
// Revenue
export const GET_ALLREVENUE_DATA = "/apps/revenue";
