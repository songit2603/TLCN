...
const MyCartDropdown = (props) => {
  ...
  useEffect(() => {
    ...
    if (customer && customer.cart && customer.cart.items) {
      ...
      setCartItem(customer.cart.items.length);
    }
  }, [customer]);
  ...
  const handleItemClick = (item) => {
    router.push(`/product-details-v2/${item.product._id}`);
  };
            ...
            <Row className="align-items-center">
              ...
              <div className="col-auto">
                <span className="badge bg-warning-subtle text-warning fs-13">
                  <span className="cartitem-badge"> {cartItem} </span> sản phẩm
                </span>
              </div>
            </Row>
          </div>
            ...
            <div className="p-2">
              ...
              >
                ...
                <Link href="/apps-ecommerce-products">
                  <button className="btn btn-success w-md mb-3">
                    Shop Now
                  </button>
                </Link>
              </div>
