...
export const deleteCategory = category => api.delete(url.DELETE_CATEGORY, { headers: { category }});
// update Categories
export const updateCategory = category => api.update(url.UPDATE_CATEGORY + '/' + category._id, category);
//brand
export const getBrands = () => api.get(url.GET_BRANDS);
export const addNewBrand = brand => api.create(url.ADD_NEW_BRAND, brand);
export const deleteBrand = brand => api.delete(url.DELETE_BRAND,{ headers: { brand }});
export const updateBrand = brand => api.update(url.UPDATE_BRAND + '/' + brand._id, brand);
...
// get Orders ID
export const getOrderById = orderId => api.getById(url.GET_ORDERS_BY_ID+'/'+orderId);
...
// add Cart
export const addNewCart = (cart) => api.create(url.ADD_NEW_CART,cart);
// update Cart
export const updateCart = (cartItem) => api.patch(url.UPDATE_CART,cartItem);
// delete Cart
export const deleteCart = (cartItem) => api.deleteWithBody(url.DELETE_CART,cartItem);
// get Customers
export const getCustomers = () => api.get(url.GET_CUSTOMERS);
// get Customers by id
export const getCustomerById = customer => api.getById(url.GET_CUSTOMERS+'/'+ customer);
