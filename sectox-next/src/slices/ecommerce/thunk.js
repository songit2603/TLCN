...
export const addNewCart = createAsyncThunk("ecommerce/addNewCart", async (cart) => {
  try {
    ...
    toast.success("Cart Added Successfully", { autoClose: 3000 });
    return data;
  } catch (error) {
    toast.error("Cart Added Failed", { autoClose: 3000 });
    throw error;
  }
});
export const updateCart = createAsyncThunk("ecommerce/updateCart", async (cartItem) => {
  try {
    ...
    toast.error("Cart Update Failed", { autoClose: 3000 });
    throw error;
  }
});
export const deleteCart = createAsyncThunk("ecommerce/deleteCart", async (cartItem) => {
  try {
    ...
    const data = await response; // Chú ý: Phải parse response thành JSON nếu cần
    toast.success("Cart Delete Successfully", { autoClose: 3000 });
    return data;
  } catch (error) {
    toast.error("Cart Delete Failed", { autoClose: 3000 });
    throw error;
  }
});
